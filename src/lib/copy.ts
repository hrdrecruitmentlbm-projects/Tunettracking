export const COPY = {
  ...
  attendance: {
    ...
    todoFormDescription: "Isi foto selfie dan minimal 1 to-do list sebelum absen berangkat.",
    todoPlaceholder: "Tugas",
    todoAddItem: "Tambah Item",
    todoSubmit: "Absen Berangkat",
    todoRequired: "Minimal 1 to-do list wajib diisi saat absen berangkat",
