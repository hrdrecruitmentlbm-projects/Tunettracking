export const COPY = {
  empty: {
    ...
    noMarketingOnMap: {
      title: "Tidak ada anggota Marketing di radar",
      description: "Belum ada anggota Marketing yang membagikan lokasinya.",
    },
    noMatchingMembers: {
  ...
  pages: {
    admin: {
      ...
      newToday: "Tugas Baru Hari Ini",
      completedToday: "Selesai Hari Ini",
      activeToday: "Tim Aktif",
      vsYesterday: "vs kemarin",
      dailyActivity: "Aktivitas Harian",
      dailyActivitySub: (days: number) => `${days} hari terakhir`,
      perUserActivity: "Aktivitas Per Tim",
      tasksAssigned: "tugas",
      completionRate: "selesai",
      noPingsYet: "Belum ada data aktivitas hari ini",
    },
    team: {
      title: "Manajemen Tim",
    ...
    map: {
      ...
      marketingCount: (n: number) => `Marketing (${n})`,
      inOffice: "Di Kantor",
    ...
    trash: "Sampah",
      ...
      typeAll: "Semua",
      typeTasks: "Tugas",
      typeProspects: "Prospek",
      typeTower: "Tower",
    },
    marketing: {
      title: "Dasbor Marketing",
      subtitle: "Ringkasan aktivitas marketing",
      activeProspects: "Prospek Aktif",
      visitsToday: "Kunjungan Hari Ini",
      towerApproved: "Tower Disetujui",
      totalVisits: "Total Kunjungan",
      prospectPipeline: "Pipeline Prospek",
      towerPipeline: "Pipeline Tower",
      recentVisits: "Kunjungan Terakhir",
      teamOverview: "Tim Marketing",
    },
    prospects: {
      title: "Manajemen Prospek",
      subtitle: "Kelola data prospek dan follow-up",
      addNew: "Tambah Prospek",
      editTitle: "Edit Prospek",
      createTitle: "Tambah Prospek Baru",
      name: "Nama",
      phone: "Telepon",
      address: "Alamat",
      area: "Area",
      ...
      deleted: "Prospek dipindahkan ke sampah",
      restored: "Prospek berhasil dipulihkan",
      failedCreate: "Gagal membuat prospek",
      failedUpdate: "Gagal memperbarui prospek",
      failedDelete: "Gagal menghapus prospek",
      empty: {
        title: "Belum ada prospek",
        description: "Tambahkan prospek pertama untuk memulai.",
      },
      colName: "Nama",
      colPhone: "Telepon",
      colArea: "Area",
    ...
    towerSites: {
      title: "Manajemen Tower Sites",
      subtitle: "Kelola data lokasi tower",
      addNew: "Tambah Tower Site",
      editTitle: "Edit Tower Site",
      createTitle: "Tambah Tower Site Baru",
      name: "Nama Situs",
      ...
      creating: "Membuat...",
      saving: "Menyimpan...",
      created: "Tower site berhasil dibuat!",
      updated: "Tower site berhasil diperbarui!",
      deleted: "Tower site dipindahkan ke sampah",
      restored: "Tower site berhasil dipulihkan",
      failedCreate: "Gagal membuat tower site",
      failedUpdate: "Gagal memperbarui tower site",
      failedDelete: "Gagal menghapus tower site",
      empty: {
        title: "Belum ada tower site",
        description: "Tambahkan tower site pertama untuk memulai.",
      },
      colName: "Nama",
      colType: "Jenis",
      colContact: "Kontak",
    ...
    kunjungan: {
      title: "Log Kunjungan",
      subtitle: "Riwayat kunjungan lapangan",
      tabProspek: "Prospek",
      tabTower: "Tower",
      logVisit: "Catat Kunjungan",
      selectItem: "Pilih item",
      selectStatus: "Pilih status",
      notes: "Catatan",
      notesPlaceholder: "Isi hasil kunjungan...",
      shareLocation: "Bagikan Lokasi",
      locationRequired: "Lokasi wajib dibagikan saat mencatat kunjungan",
      saved: "Kunjungan berhasil dicatat!",
      failedSave: "Gagal menyimpan kunjungan",
      empty: {
        title: "Belum ada kunjungan",
        description: "Riwayat kunjungan akan muncul di sini.",
      },
      colDate: "Tanggal",
      colType: "Tipe",
      colName: "Nama",
    ...
    trash: {
      title: "Sampah",
      subtitle: "Item yang dihapus",
      restore: "Pulihkan",
      permanentlyDelete: "Hapus Permanen",
      restored: "Berhasil dipulihkan",
      failedRestore: "Gagal memulihkan item",
      empty: {
        title: "Sampah kosong",
      ...
      colName: "Nama",
      colType: "Tipe",
      colDeletedBy: "Dihapus oleh",
      colDeletedAt: "Tanggal hapus",
      colActions: "Aksi",
    },
    settings: {
      title: "Pengaturan",
  ...
  taskList: {
    ...
    ungroup: "Daftar",
    // ==== Admin triage list ====
    groupLabel: "Kelompokkan",
    groupNone: "Datar",
    groupStatus: "Status",
    groupAssignee: "Penerima",
    groupDeadline: "Tenggat",
    sortLabel: "Urutkan",
    sortRisk: "Risiko",
    sortDeadline: "Tenggat",
    sortPriority: "Prioritas",
    sortUpdated: "Terbaru",
    sortBy: (column: string) => `Urutkan berdasarkan ${column}`,
    presetLabel: "Tampilan cepat",
    presetAll: "Semua",
    presetRisk: "Butuh tindakan",
    presetOverdue: "Terlambat",
    presetUnassigned: "Belum ditugaskan",
    presetWorkload: "Beban tim",
    unassignedGroup: "Belum ditugaskan",
    activeCount: (n: number) => `${n} aktif`,
    overdueCount: (n: number) => `${n} terlambat`,
    capacityOf: (current: number, capacity: number) => `kapasitas ${current}/${capacity}`,
    capacityFull: "kapasitas penuh",
    staleDays: (n: number) => `${n} hr`,
    stalledNotice: (n: number) => `Belum diperbarui ${n} hari`,
    deadlineOverdue: "Terlambat",
    deadlineToday: "Hari ini",
    deadlineWeek: "7 hari ke depan",
    deadlineLater: "Nanti",
    deadlineNone: "Tanpa tenggat",
  ...
  bulkActions: {
    ...
    selectAll: (n: number) => `Pilih semua ${n} tugas`,
    selectRow: (title: string) => `Pilih tugas ${title}`,
    changeStatus: "Ubah Status",
    reassign: "Tugaskan Ulang",
    delete: "Hapus",
  ...
  attendance: {
    ...
    photoTitle: "Foto Absensi",
    photoDescription: "Ambil foto selfie untuk absen berangkat",
    photoCapture: "Ambil Foto",
    photoRetake: "Ambil Ulang",
    photoRequired: "Foto wajib diunggah saat absen berangkat",
    photoUploading: "Mengunggah foto...",
    photoFailed: "Gagal mengunggah foto",
    photoTooLarge: "Ukuran foto maksimal 5MB",
    photoInvalidType: "Format foto harus JPEG, PNG, atau WebP",
    photoPreview: "Preview Foto",
  },
};
