...
function createCustomIcon(color: string, initials: string, pulsing: boolean = false) {
  return L.divIcon({
...
export function RadarMap({ height = "100%" }: RadarMapProps) {
        ...
        {locations.map((location) => {
          ...
          return (
            <Marker
              ...
              icon={createCustomIcon(color, initials, hasOverdue)}
            >
              <Popup>
                <div className="p-1">
